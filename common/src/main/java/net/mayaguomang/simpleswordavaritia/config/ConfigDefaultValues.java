...
public class ConfigDefaultValues {
    ...
    public static float abilityAbsorptionCap = 20f;

    
    public static float watcherChance = 5f;
    public static float watcherRestoreAmount = 0.5f;
    public static float watcherRadius = 8f;
    public static float omenChance = 5f;
    public static float omenAbsorptionCap = 20f;
    public static float omenInstantKillThreshold = 0.25f;

    
    public static float stealChance = 25f;
    public static float stealDuration = 400f;
    public static float stealInvisDuration = 120f;
    public static float stealBlindDuration = 200f;
    public static float stealRadius = 30f;
    public static float stealSpellScaling = 2.6f;

    
    public static float soulMeldChance = 75f;
    public static float soulMeldDuration = 250f;
    public static float soulMeldRadius = 5f;

    
    public static float soulrendChance = 85f;
    public static float soulrendDuration = 500f;
    public static float soulrendDamageMulti = 3f;
    public static float soulrendHealMulti = 0.5f;
    public static float soulrendRadius = 10f;
    public static float soulrendMaxStacks = 8f;
    public static float soulrendDamageSpellScaling = 0.4f;

    
    public static float ferocityChance = 75f;
    public static float ferocityDuration = 100f;
    public static float ferocityMaxStacks = 15f;
    public static float ferocityStrengthTier = 2f;

    
    public static float emberIreChance = 30f;
    public static float emberIreDuration = 150f;

    
    public static float volcanicFuryChance = 25f;
    public static float volcanicFuryRadius = 3f;
    public static float volcanicFuryCooldown = 300f;
    public static float volcanicFuryDamage = 3f;
    ...
    public static float brimstoneChance = 15f;
    ...
    public static float soultetherRadius = 8f;
    public static float soultetherDuration = 120f;
    public static float soultetherIgniteDuration = 120f;
    public static float soultetherResistanceDuration = 60f;

    
    public static float frostFuryCooldown = 380f;
    public static float frostFuryRadius = 3f;
    public static float frostFuryDamage = 18f;
    public static float frostFuryChance = 15f;
    public static float frostFuryDuration = 80f;
    public static float frostFurySpellScaling = 1.4f;

    
    public static float moltenRoarCooldown = 320f;
    public static float moltenRoarRadius = 5f;
    public static float moltenRoarKnockbackStrength = 5f;
    public static float moltenRoarChance = 15f;
    public static float moltenRoarDuration = 100f;

    
    public static float frostShatterRadius = 3f;
    public static float frostShatterDamage = 18f;
    public static float frostShatterChance = 15f;
    public static float frostShatterDuration = 80f;
    public static float frostShatterSpellScaling = 1.7f;

    
    public static float permafrostRadius = 4f;
    public static float permafrostDamage = 1f;
    public static float permafrostCooldown = 600f;
    public static float permafrostDuration = 200f;
    public static float permafrostSpellScaling = 0.9f;

    
    public static float arcaneAssaultRadius = 6f;
    public static float arcaneAssaultDamage = 1f;
    public static float arcaneAssaultCooldown = 220;
    public static float arcaneAssaultChance = 25f;
    public static float arcaneAssaultDuration = 120f;
    public static float arcaneAssaultSpellScaling = 1.4f;

    
    public static float thunderBlitzRadius = 2f;
    public static float thunderBlitzDamage = 3f;
    public static float thunderBlitzCooldown = 250;
    public static float thunderBlitzChance = 15f;
    public static float thunderBlitzSpellScaling = 1.7f;

    
    public static float stormJoltCooldown = 100f;
    public static float stormJoltChance = 15f;

    
    public static float soulAnguishRadius = 3f;
    public static float soulAnguishAbsorptionCap = 8f;
    public static float soulAnguishDamage = 4f;
    public static float soulAnguishCooldown = 700;
    public static float soulAnguishDuration = 200f;
    public static float soulAnguishHeal = 0.5f;
    public static float soulAnguishRange = 22f;
    public static float soulAnguishSpellScaling = 1.6f;

    
    public static float shockDeflectBlockDuration = 35f;
    public static float shockDeflectDamage = 12f;
    public static float shockDeflectCooldown = 90;
    public static float shockDeflectParryDuration = 10f;
    public static float shockDeflectSpellScaling = 2.3f;

    
    public static float shadowmistCooldown = 200f;
    public static float shadowmistChance = 25f;
    public static float shadowmistDamageMulti = 0.8f;
    public static float shadowmistBlindDuration = 60f;
    public static float shadowmistRadius = 4f;

    
    public static float abyssalStandardCooldown = 700;
    public static float abyssalStandardChance = 15f;
    public static float abyssalStandardDamage = 3f;
    public static float abyssalStandardSpellScaling = 1.2f;

    
    public static float righteousStandardCooldown = 700f;
    public static float righteousStandardChance = 15f;
    public static float righteousStandardDamage = 3f;
    public static float righteousStandardSpellScaling = 1.1f;
    public static float righteousStandardSpellScalingHeal = 1.3f;

    
    public static float fatalFlickerCooldown = 175f;
    public static float fatalFlickerChance = 15f;
    ...
    public static float swiftnessChance = 15f;
    public static float swiftnessDuration= 300f;

    
    public static float slowChance = 50f;
    public static float slowDuration= 50f;

    
    public static float poisonChance = 15f;
    public static float poisonDuration = 150f;

    
    public static float freezeChance = 15f;
    public static float freezeDuration = 120f;

    
    public static float wildfireChance = 10f;
    public static float wildfireDuration = 180f;
    public static float wildfireRadius = 10;

    
    public static float floatChance = 15f;
    public static float floatDuration = 50f;

    
    public static float zephyrChance = 15f;
    public static float zephyrDuration = 180f;

    
    public static float shieldingChance = 15f;
    public static float shieldingDuration = 120f;

    
    public static float stoneskinChance = 15f;
    public static float stoneskinDuration = 60f;

    
    public static float trailblazeChance = 15f;
    public static float trailblazeDuration = 120;

    
    public static float weakenChance = 15f;
    public static float weakenDuration = 120f;

    
    public static float unstableFrequency = 140f;
    public static float unstableDuration = 140f;

    
    public static float activeDefenceFrequency = 20f;
    public static float activeDefenceRadius = 5f;

    
    public static float frostWardFrequency = 20f;
    public static float frostWardRadius = 5f;
    public static float frostWardDuration = 60f;

    
    public static float momentumCooldown = 140f;

    
    public static float imbuedChance = 15;
    ...
    // -- AVARITIA COMPAT WEAPONS -- //
    // Infinity Series (T3) - Base 15 weapons
    public static float infinity_longsword_damageModifier = 25.0f;
    public static float infinity_longsword_attackSpeed = -2.4f;
    public static float infinity_twinblade_damageModifier = 25.0f;
    public static float infinity_twinblade_attackSpeed = -2.0f;
    public static float infinity_rapier_damageModifier = 24.0f;
    public static float infinity_rapier_attackSpeed = -1.8f;
    public static float infinity_katana_damageModifier = 25.0f;
    public static float infinity_katana_attackSpeed = -2.0f;
    public static float infinity_sai_damageModifier = 22.0f;
    public static float infinity_sai_attackSpeed = -1.5f;
    public static float infinity_spear_damageModifier = 246.0f;
    public static float infinity_spear_attackSpeed = 1.3f;
    public static float infinity_glaive_damageModifier = 25.0f;
    public static float infinity_glaive_attackSpeed = -2.6f;
    public static float infinity_warglaive_damageModifier = 25.0f;
    public static float infinity_warglaive_attackSpeed = -2.2f;
    public static float infinity_cutlass_damageModifier = 25.0f;
    public static float infinity_cutlass_attackSpeed = -2.0f;
    public static float infinity_claymore_damageModifier = 27.0f;
    public static float infinity_claymore_attackSpeed = -2.8f;
    public static float infinity_greathammer_damageModifier = 29.0f;
    public static float infinity_greathammer_attackSpeed = -3.2f;
    public static float infinity_greataxe_damageModifier = 296.0f;
    public static float infinity_greataxe_attackSpeed = 0.9f;
    public static float infinity_chakram_damageModifier = 24.0f;
    public static float infinity_chakram_attackSpeed = -3.0f;
    public static float infinity_scythe_damageModifier = 26.0f;
    public static float infinity_scythe_attackSpeed = -2.7f;
    public static float infinity_halberd_damageModifier = 28.0f;
    public static float infinity_halberd_attackSpeed = -2.8f;
    
    // Crystal Series (T2) - Base 15 weapons
    public static float crystal_longsword_damageModifier = 18.0f;
    public static float crystal_longsword_attackSpeed = -2.4f;
    public static float crystal_twinblade_damageModifier = 18.0f;
    public static float crystal_twinblade_attackSpeed = -2.0f;
    public static float crystal_rapier_damageModifier = 17.0f;
    public static float crystal_rapier_attackSpeed = -1.8f;
    public static float crystal_katana_damageModifier = 18.0f;
    public static float crystal_katana_attackSpeed = -2.0f;
    public static float crystal_sai_damageModifier = 15.0f;
    public static float crystal_sai_attackSpeed = -1.5f;
    public static float crystal_spear_damageModifier = 18.0f;
    public static float crystal_spear_attackSpeed = -2.7f;
    public static float crystal_glaive_damageModifier = 18.0f;
    public static float crystal_glaive_attackSpeed = -2.6f;
    public static float crystal_warglaive_damageModifier = 18.0f;
    public static float crystal_warglaive_attackSpeed = -2.2f;
    public static float crystal_cutlass_damageModifier = 18.0f;
    public static float crystal_cutlass_attackSpeed = -2.0f;
    public static float crystal_claymore_damageModifier = 20.0f;
    public static float crystal_claymore_attackSpeed = -2.8f;
    public static float crystal_greathammer_damageModifier = 22.0f;
    public static float crystal_greathammer_attackSpeed = -3.2f;
    public static float crystal_greataxe_damageModifier = 21.0f;
    public static float crystal_greataxe_attackSpeed = -3.1f;
    public static float crystal_chakram_damageModifier = 17.0f;
    public static float crystal_chakram_attackSpeed = -3.0f;
    public static float crystal_scythe_damageModifier = 19.0f;
    public static float crystal_scythe_attackSpeed = -2.7f;
    public static float crystal_halberd_damageModifier = 21.0f;
    public static float crystal_halberd_attackSpeed = -2.8f;
    
    // BlazeIron Series (T1) - Base 15 weapons
    public static float blazeiron_longsword_damageModifier = 12.0f;
    public static float blazeiron_longsword_attackSpeed = -2.4f;
    public static float blazeiron_twinblade_damageModifier = 12.0f;
    public static float blazeiron_twinblade_attackSpeed = -2.0f;
    public static float blazeiron_rapier_damageModifier = 11.0f;
    public static float blazeiron_rapier_attackSpeed = -1.8f;
    public static float blazeiron_katana_damageModifier = 12.0f;
    public static float blazeiron_katana_attackSpeed = -2.0f;
    public static float blazeiron_sai_damageModifier = 9.0f;
    public static float blazeiron_sai_attackSpeed = -1.5f;
    public static float blazeiron_spear_damageModifier = 12.0f;
    public static float blazeiron_spear_attackSpeed = -2.7f;
    public static float blazeiron_glaive_damageModifier = 12.0f;
    public static float blazeiron_glaive_attackSpeed = -2.6f;
    public static float blazeiron_warglaive_damageModifier = 12.0f;
    public static float blazeiron_warglaive_attackSpeed = -2.2f;
    public static float blazeiron_cutlass_damageModifier = 12.0f;
    public static float blazeiron_cutlass_attackSpeed = -2.0f;
    public static float blazeiron_claymore_damageModifier = 14.0f;
    public static float blazeiron_claymore_attackSpeed = -2.8f;
    public static float blazeiron_greathammer_damageModifier = 16.0f;
    public static float blazeiron_greathammer_attackSpeed = -3.2f;
    public static float blazeiron_greataxe_damageModifier = 15.0f;
    public static float blazeiron_greataxe_attackSpeed = -3.1f;
    public static float blazeiron_chakram_damageModifier = 11.0f;
    public static float blazeiron_chakram_attackSpeed = -3.0f;
    public static float blazeiron_scythe_damageModifier = 13.0f;
    public static float blazeiron_scythe_attackSpeed = -2.7f;
    public static float blazeiron_halberd_damageModifier = 15.0f;
    public static float blazeiron_halberd_attackSpeed = -2.8f;
    
    // Simply More Additional Weapons - Infinity Series (T3)
    public static float infinity_greatkatana_damageModifier = 26.0f;
    public static float infinity_greatkatana_attackSpeed = -2.2f;
    public static float infinity_lance_damageModifier = 27.0f;
    public static float infinity_lance_attackSpeed = -2.9f;
    public static float infinity_grandsword_damageModifier = 28.0f;
    public static float infinity_grandsword_attackSpeed = -3.0f;
    public static float infinity_backhandblade_damageModifier = 23.0f;
    public static float infinity_backhandblade_attackSpeed = -1.9f;
    public static float infinity_khopesh_damageModifier = 25.0f;
    public static float infinity_khopesh_attackSpeed = -2.3f;
    public static float infinity_dagger_damageModifier = 20.0f;
    public static float infinity_dagger_attackSpeed = -1.2f;
    public static float infinity_pernach_damageModifier = 26.0f;
    public static float infinity_pernach_attackSpeed = -2.5f;
    public static float infinity_greatspear_damageModifier = 27.0f;
    public static float infinity_greatspear_attackSpeed = -2.8f;
    public static float infinity_quarterstaff_damageModifier = 24.0f;
    public static float infinity_quarterstaff_attackSpeed = -2.3f;
    public static float infinity_deerhorns_damageModifier = 23.0f;
    public static float infinity_deerhorns_attackSpeed = -1.7f;
    
    // Simply More Additional Weapons - Crystal Series (T2)
    public static float crystal_greatkatana_damageModifier = 19.0f;
    public static float crystal_greatkatana_attackSpeed = -2.2f;
    public static float crystal_lance_damageModifier = 20.0f;
    public static float crystal_lance_attackSpeed = -2.9f;
    public static float crystal_grandsword_damageModifier = 21.0f;
    public static float crystal_grandsword_attackSpeed = -3.0f;
    public static float crystal_backhandblade_damageModifier = 16.0f;
    public static float crystal_backhandblade_attackSpeed = -1.9f;
    public static float crystal_khopesh_damageModifier = 18.0f;
    public static float crystal_khopesh_attackSpeed = -2.3f;
    public static float crystal_dagger_damageModifier = 13.0f;
    public static float crystal_dagger_attackSpeed = -1.2f;
    public static float crystal_pernach_damageModifier = 19.0f;
    public static float crystal_pernach_attackSpeed = -2.5f;
    public static float crystal_greatspear_damageModifier = 20.0f;
    public static float crystal_greatspear_attackSpeed = -2.8f;
    public static float crystal_quarterstaff_damageModifier = 17.0f;
    public static float crystal_quarterstaff_attackSpeed = -2.3f;
    public static float crystal_deerhorns_damageModifier = 16.0f;
    public static float crystal_deerhorns_attackSpeed = -1.7f;
    
    // Simply More Additional Weapons - BlazeIron Series (T1)
    public static float blazeiron_greatkatana_damageModifier = 13.0f;
    public static float blazeiron_greatkatana_attackSpeed = -2.2f;
    public static float blazeiron_lance_damageModifier = 14.0f;
    public static float blazeiron_lance_attackSpeed = -2.9f;
    public static float blazeiron_grandsword_damageModifier = 15.0f;
    public static float blazeiron_grandsword_attackSpeed = -3.0f;
    public static float blazeiron_backhandblade_damageModifier = 10.0f;
    public static float blazeiron_backhandblade_attackSpeed = -1.9f;
    public static float blazeiron_khopesh_damageModifier = 12.0f;
    public static float blazeiron_khopesh_attackSpeed = -2.3f;
    public static float blazeiron_dagger_damageModifier = 7.0f;
    public static float blazeiron_dagger_attackSpeed = -1.2f;
    public static float blazeiron_pernach_damageModifier = 13.0f;
    public static float blazeiron_pernach_attackSpeed = -2.5f;
    public static float blazeiron_greatspear_damageModifier = 14.0f;
    public static float blazeiron_greatspear_attackSpeed = -2.8f;
    public static float blazeiron_quarterstaff_damageModifier = 11.0f;
    public static float blazeiron_quarterstaff_attackSpeed = -2.3f;
    public static float blazeiron_deerhorns_damageModifier = 10.0f;
    public static float blazeiron_deerhorns_attackSpeed = -1.7f;
