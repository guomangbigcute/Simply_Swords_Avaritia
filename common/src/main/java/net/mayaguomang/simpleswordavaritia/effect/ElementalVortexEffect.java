...
import net.mayaguomang.simpleswordavaritia.util.SoundHelper;
...
public class ElementalVortexEffect extends OrbitingEffect {
    ...
    public void applyUpdateEffect(LivingEntity livingEntity, int amplifier) {
        if (!livingEntity.getWorld().isClient()) {
            ...
            if (livingEntity.getStatusEffect(EffectRegistry.ELEMENTAL_VORTEX.get()) instanceof SimpleSwordAvaritiaStatusEffectInstance statusEffect) {
