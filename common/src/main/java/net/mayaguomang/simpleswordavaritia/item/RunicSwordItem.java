...
public class RunicSwordItem extends SwordItem {
    ...
    public void appendTooltip(ItemStack itemStack, World world, List<Text> tooltip, TooltipContext tooltipContext) {
        ...
        if (itemStack.getOrCreateNbt().getString("runic_power").isEmpty()) {
            tooltip.add(Text.translatable("item.SimpleSwordAvaritia.unidentifiedsworditem.tooltip1").setStyle(RUNIC));
            tooltip.add(Text.translatable("item.SimpleSwordAvaritia.unidentifiedsworditem.tooltip2").setStyle(TEXT));
        } else {
            if (itemStack.getOrCreateNbt().getString("runic_power").contains("greater")) {
                tooltip.add(Text.translatable("item.SimpleSwordAvaritia.greater_runic_power").setStyle(RUNIC).formatted(Formatting.BOLD));
            }
            switch (itemStack.getOrCreateNbt().getString("runic_power")) {
                case "freeze" -> {
                    tooltip.add(Text.translatable("item.SimpleSwordAvaritia.freezesworditem.tooltip1").setStyle(RUNIC));
                    tooltip.add(Text.translatable("item.SimpleSwordAvaritia.freezesworditem.tooltip2").setStyle(TEXT));
                }
                case "wildfire" -> {
                    tooltip.add(Text.translatable("item.SimpleSwordAvaritia.wildfiresworditem.tooltip1").setStyle(RUNIC));
                ...
                case "slow", "greater_slow" -> {
                    tooltip.add(Text.translatable("item.SimpleSwordAvaritia.slownesssworditem.tooltip1").setStyle(RUNIC));
                ...
                case "swiftness", "greater_swiftness" -> {
                    tooltip.add(Text.translatable("item.SimpleSwordAvaritia.speedsworditem.tooltip1").setStyle(RUNIC));
                ...
                case "float", "greater_float" -> {
                    tooltip.add(Text.translatable("item.SimpleSwordAvaritia.levitationsworditem.tooltip1").setStyle(RUNIC));
                ...
                case "zephyr", "greater_zephyr" -> {
                    tooltip.add(Text.translatable("item.SimpleSwordAvaritia.zephyrsworditem.tooltip1").setStyle(RUNIC));
                ...
                case "shielding", "greater_shielding" -> {
                    tooltip.add(Text.translatable("item.SimpleSwordAvaritia.shieldingsworditem.tooltip1").setStyle(RUNIC));
                ...
                case "stoneskin", "greater_stoneskin" -> {
                    tooltip.add(Text.translatable("item.SimpleSwordAvaritia.stoneskinsworditem.tooltip1").setStyle(RUNIC));
                ...
                case "frost_ward" -> {
                    tooltip.add(Text.translatable("item.SimpleSwordAvaritia.frostwardsworditem.tooltip1").setStyle(RUNIC));
                ...
                case "trailblaze", "greater_trailblaze" -> {
                    tooltip.add(Text.translatable("item.SimpleSwordAvaritia.trailblazesworditem.tooltip1").setStyle(RUNIC));
                ...
                case "active_defence" -> {
                    tooltip.add(Text.translatable("item.SimpleSwordAvaritia.activedefencesworditem.tooltip1").setStyle(RUNIC));
                ...
                case "weaken", "greater_weaken" -> {
                    tooltip.add(Text.translatable("item.SimpleSwordAvaritia.weakensworditem.tooltip1").setStyle(RUNIC));
                ...
                case "unstable" -> {
                    tooltip.add(Text.translatable("item.SimpleSwordAvaritia.unstablesworditem.tooltip1").setStyle(RUNIC));
                ...
                case "momentum", "greater_momentum" -> {
                    tooltip.add(Text.translatable("item.SimpleSwordAvaritia.momentumsworditem.tooltip1").setStyle(RUNIC));
                    tooltip.add(Text.translatable("item.SimpleSwordAvaritia.momentumsworditem.tooltip2").setStyle(TEXT));
                    tooltip.add(Text.translatable("item.SimpleSwordAvaritia.momentumsworditem.tooltip3").setStyle(TEXT));
                }
                case "imbued", "greater_imbued" -> {
                    tooltip.add(Text.translatable("item.SimpleSwordAvaritia.imbuedsworditem.tooltip1").setStyle(RUNIC));
                ...
                case "pincushion", "greater_pincushion" -> {
                    tooltip.add(Text.translatable("item.SimpleSwordAvaritia.pincushionsworditem.tooltip1").setStyle(RUNIC));
                ...
                case "ward" -> {
                    tooltip.add(Text.translatable("item.SimpleSwordAvaritia.wardsworditem.tooltip1").setStyle(RUNIC));
                    tooltip.add(Text.literal(""));
                    tooltip.add(Text.translatable("item.SimpleSwordAvaritia.onrightclick").setStyle(RIGHTCLICK));
                    tooltip.add(Text.translatable("item.SimpleSwordAvaritia.wardsworditem.tooltip2").setStyle(TEXT));
                    tooltip.add(Text.translatable("item.SimpleSwordAvaritia.wardsworditem.tooltip3").setStyle(TEXT));
                    tooltip.add(Text.translatable("item.SimpleSwordAvaritia.wardsworditem.tooltip4").setStyle(TEXT));
                }
                case "immolation" -> {
                    tooltip.add(Text.translatable("item.SimpleSwordAvaritia.immolationsworditem.tooltip1").setStyle(RUNIC));
                    tooltip.add(Text.literal(""));
                    tooltip.add(Text.translatable("item.SimpleSwordAvaritia.onrightclick").setStyle(RIGHTCLICK));
                    tooltip.add(Text.translatable("item.SimpleSwordAvaritia.immolationsworditem.tooltip2").setStyle(TEXT));
                    tooltip.add(Text.translatable("item.SimpleSwordAvaritia.immolationsworditem.tooltip3").setStyle(TEXT));
                    tooltip.add(Text.translatable("item.SimpleSwordAvaritia.immolationsworditem.tooltip4").setStyle(TEXT));
                }
            }
        }
    }
