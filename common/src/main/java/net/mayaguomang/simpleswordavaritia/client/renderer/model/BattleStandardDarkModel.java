package net.mayaguomang.simpleswordavaritia.client.renderer.model;
...
public class BattleStandardDarkModel extends EntityModel<BattleStandardDarkEntity> {
	...
	public BattleStandardDarkModel(ModelPart root) {
	...
	@Override
	public void setAngles(BattleStandardDarkEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
