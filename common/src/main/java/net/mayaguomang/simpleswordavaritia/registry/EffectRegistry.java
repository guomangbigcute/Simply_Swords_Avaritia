...
import net.mayaguomang.simpleswordavaritia.effect.*;

public class EffectRegistry {

    public static final DeferredRegister<StatusEffect> EFFECT = DeferredRegister.create(SimpleSwordAvaritia.MOD_ID, RegistryKeys.STATUS_EFFECT);
    ...
    // DISABLED: FRENZY effect - requires FrenzyEffect class which is disabled
    /*
    ...
    */
    ...
    // DISABLED: RIBBONCLEAVE effect - requires RibboncleaveEffect class which is disabled
    /*
    ...
    */
    ...
    // DISABLED: SPORE_SWARM effect - requires SporeSwarmEffect class which is disabled
    /*
    ...
    */
    ...
    // DISABLED: MAGISTORM effect - requires MagistormEffect class which is disabled
    /*
